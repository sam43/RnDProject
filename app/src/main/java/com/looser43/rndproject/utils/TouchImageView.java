...
public class TouchImageView extends ImageView {
    ...
    /**
     * Set zoom parameters equal to another {@link TouchImageView}. Including scale, position,
     * and ScaleType.
     *
     * @param img - {@link TouchImageView}
     */
    ...
    private void printMatrixInfo() {
        float[] n = new float[9];
        matrix.getValues(n);
        // Lg.d(TAG, "Scale: " + n[Matrix.MSCALE_X] + " TransX: " + n[Matrix.MTRANS_X] + " TransY: " + n[Matrix.MTRANS_Y]);
    }
